var i18n = {
  'YouTube WebM Plus options': 'YouTube WebM Plus valg',
  ...
  'Embed alternate player instead of using Flash': 'Bruk alternativ avspiller istedenfor Flash',
  'Add a ‘Download Video’ button below all WebM videos': 'Legg til en ‹Last ned video› knapp under alle WebM videoer',
  'Hide promotions for Adobe Flash Player': 'Skjul reklame for Adobe Flash Player',
  'Done': 'Ferdig',
  'Open source on Github': 'Åpen kode på Github'
};